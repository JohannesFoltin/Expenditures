...
class ConsumendMoneyWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Center(
        child: Text(
          '${state.getDayExpendituresImportantValue(state.expendituresOnCurrentDay)}€ von ${state.trip.dailyLimit}€ verbraucht. (${state.getDayExpendituresAllValue(state.expendituresOnCurrentDay)})',
        ),
      ),
    );
  }
